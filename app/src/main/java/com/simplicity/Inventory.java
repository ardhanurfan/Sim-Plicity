...
public class Inventory {
    ...
    // // daftar_barang[0] = new ObjekNonMakanan("Kasur Single\t", 4, 1, 50,
    // "Tidur");
    // // daftar_barang[1] = new ObjekNonMakanan("Kasur Queen Size", 4, 2, 100,
    // "Tidur");
    // // daftar_barang[2] = new ObjekNonMakanan("Kasur King Size ", 5, 2, 150,
    // "Tidur");
    // // daftar_barang[3] = new ObjekNonMakanan("Toilet\t\t", 1, 1, 50, "Buang
    // air");
    // // daftar_barang[4] = new ObjekNonMakanan("Kompor Gas\t", 2, 1, 100,
    // "Memasak");
    // // daftar_barang[5] = new ObjekNonMakanan("Kompor Listrik\t", 1, 1, 200,
    // "Memasak");
    // // daftar_barang[6] = new ObjekNonMakanan("Meja dan Kursi\t", 3, 3, 50,
    // "Makan");
    // // daftar_barang[7] = new ObjekNonMakanan("Jam\t\t", 1, 1, 10, "Melihat
    // Waktu");

    // // List objek makanan
    // ObjekMakanan[] daftar_makanan = new ObjekMakanan[5];

    // daftar_makanan[0] = new ObjekMakanan("Nasi Ayam", new ObjekBahanMakanan[] {
    // nasi, ayam }, 16);
    // daftar_makanan[1] = new ObjekMakanan("Nasi Kari", new ObjekBahanMakanan[] {
    // nasi, kentang, wortel, sapi }, 30);
    // daftar_makanan[2] = new ObjekMakanan("Susu Kacang", new ObjekBahanMakanan[] {
    // susu, kacang }, 5);
    // daftar_makanan[3] = new ObjekMakanan("Tumis Sayur", new ObjekBahanMakanan[] {
    // wortel, bayam }, 5);
    // daftar_makanan[4] = new ObjekMakanan("Bistik\t", new ObjekBahanMakanan[] {
    // kentang, sapi }, 22);
